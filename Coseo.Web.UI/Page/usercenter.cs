    ...
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            if (action == "exit")
            {
                ...
                //清除Cookies
                Utils.WriteCookie(DTKeys.COOKIE_USER_NAME_REMEMBER, "Coseo", -43200);
                Utils.WriteCookie(DTKeys.COOKIE_USER_PWD_REMEMBER, "Coseo", -43200);
                Utils.WriteCookie("UserName", "Coseo", -1);
                Utils.WriteCookie("Password", "Coseo", -1);
                //自动登录,跳转URL
