		...
		$.ajax({ 
			...
			success: function(data) {
				...
				for(var i in data){
					...
					'<a href="#" target="_blank" class="user_avatar">';
					if(typeof(data[i].avatar) != "undefined"){
					    strHtml += '<img src="' + data[i].avatar + '" class="user_avatar-img" width="60" height="60" />';
					}else{
					    strHtml += '<img src="' + defaultAvatar + '" class="user_avatar-img" width="60" height="60" />';
					}
					strHtml += '</a>' +
					'<div class="comment-box">' +
                        ...
                        '</p>' +
					    '<p class="user-msg">' + unescape(data[i].content) + '</p>' +
