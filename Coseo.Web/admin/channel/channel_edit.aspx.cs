...
namespace Coseo.Web.admin.channel
{
    public partial class channel_edit : Web.UI.ManagePage
    {
        ...
        private string GetInherit(string page_type)
        {
            ...
            {
                case "index":
                    result = "Coseo.Web.UI.Page.article";
                    break;
                case "category":
                    result = "Coseo.Web.UI.Page.category";
                    break;
                case "list":
                    result = "Coseo.Web.UI.Page.article_list";
                    break;
                case "detail":
                    result = "Coseo.Web.UI.Page.article_show";
                    break;
            }
            return result;
        }
