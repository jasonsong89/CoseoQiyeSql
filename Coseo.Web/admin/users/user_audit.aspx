<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="Coseo.Web.admin.users.user_audit" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Coseo.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
    <td><%#Eval("email")%></td>
