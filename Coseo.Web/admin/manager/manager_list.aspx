<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_list.aspx.cs" Inherits="Coseo.Web.admin.manager.manager_list" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Coseo.BLL.manager_role().GetTitle(Convert.ToInt32(Eval("role_id")))%></td>
