<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_confirm.aspx.cs" Inherits="Coseo.Web.admin.order.order_confirm" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new Coseo.BLL.payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
    <td><%#new Coseo.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
